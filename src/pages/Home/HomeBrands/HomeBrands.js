               ...
               <div className="row">
                  ...
                  <div className="col-xl-6 col-lg-7">
                     ...
                     <div className="brand__subtitle mb-90 wow fadeInUp" data-wow-delay=".4s">
                        <p>Improving the health and safety of patients we are committed to quality and excellence in everything we do to support clients throughout the full product lifecycle.</p>
                     </div>
                  </div>
               </div>
               <div className="row">
