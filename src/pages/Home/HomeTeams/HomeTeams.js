        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <SingleTeam
              ...
              description="Qualifying in 1987, Mr Griffiths completed his formative training in the Midlands. He has worked as a clinical fellow in reproductive medicine at St James's University Hospital, Leeds and in 1994 was awarded a Fellowship to Harvard Medical School, Boston, USA. Before taking up his NHS Consultant post he also worked at the Center for Endometriosis Care, Atlanta, Georgia and various hospitals in New Zealand.Mr Griffiths was a trainer in advanced laparoscopic surgery for The University of Surrey and has taught many of the present consultants. He is currently the principal trainer for benign gynaecological surgery for the O&G trainees in the South West Deanery. Mr Griffiths has an advisory role with HBC, with a particular focus on performance management for efficiency in surgery."
            />
            <SingleTeam
              image="4"
              name="Eugene Warren"
              title="Medtech Consultant"
              description="Eugene has over 30 years experience in the medical devices industry. Having held management positions in companies such as Smith & Nephew and Zimmer Biomet, Eugene has spent the last 11 years as Managing Director of Accord Medical Ltd. Eugene brings not only expert understanding of the clinical, operational and financial workings of the UK healthcare system, but also a vast network of clinicians, across multiple specialities, to broaden HBC’s access to Key Opinion Leaders"
            />
            <SingleTeam
              image="5"
